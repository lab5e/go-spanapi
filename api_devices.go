...
func (r ApiRetrieveDeviceStatsRequest) Execute() (*DeviceStats, *http.Response, error) {
	return r.ApiService.RetrieveDeviceStatsExecute(r)
}
...
func (a *DevicesApiService) RetrieveDeviceStatsExecute(r ApiRetrieveDeviceStatsRequest) (*DeviceStats, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicesApiService.RetrieveDeviceStats")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/span/collections/{collectionId}/devices/{deviceId}/stats"
	localVarPath = strings.Replace(localVarPath, "{"+"collectionId"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"deviceId"+"}", url.PathEscape(parameterValueToString(r.deviceId, "deviceId")), -1)
