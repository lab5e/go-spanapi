...
List the gatways for the network. Some of the gatways are built into
Span and can't be deleted.
...
func (a *GatewaysApiService) ListGatewaysExecute(r ApiListGatewaysRequest) (*ListGatewayResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/span/networks/{networkId}/gateways"
...
List networks available to the collection. This will include the built-in
networks in Span.
...
func (a *GatewaysApiService) ListNetworksExecute(r ApiListNetworksRequest) (*ListNetworkResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/span/networks"
...
func (a *GatewaysApiService) RetrieveGatewayExecute(r ApiRetrieveGatewayRequest) (*Gateway, *http.Response, error) {
	...
	localVarPath := localBasePath + "/span/networks/{networkId}/gateways/{gatewayId}"
	localVarPath = strings.Replace(localVarPath, "{"+"networkId"+"}", url.PathEscape(parameterToString(r.networkId, "")), -1)
